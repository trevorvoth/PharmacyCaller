...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', isLoading, children, className = '', disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary-500 text-white hover:bg-primary-600 focus:ring-primary-500 dark:focus:ring-offset-gray-900',
      ...
      danger: 'bg-red-500 text-white hover:bg-red-600 focus:ring-red-500 dark:focus:ring-offset-gray-900',
    };
